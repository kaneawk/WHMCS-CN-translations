...
$_LANG['affiliatesbullet1'] = "您的联盟账户将会获得一笔启动奖金为：";
...
$_LANG['affiliatesintrotext'] = "现在激活您的联盟账户：";
...
$_LANG['creditcardconfirmation'] = "您的新的信用卡信息被接受并且您账户的首次付款已经完成。已发送给您一封确认邮件。";
...
$_LANG['domainrenewdesc'] = "通过续费更多的年份来保护您的域名。选择您要续订的年数，然后提交继续。";
...
$_LANG['clientareanoaddons'] = "此账户无任何附加服务";
...
$_LANG['domainnsexp'] = "在 DNS 服务器中保留有该域名的 DNS 记录，比如 A 记录，MX 记录等。修改 DNS 服务器一般在 24 小时内生效。";
$_LANG['domainlockingexp'] = "锁定您的域名，以防止域名在未经您授权的情况下被盗窃转让";
$_LANG['domaincurrentlyunlocked'] = "域名未锁定";
$_LANG['domaincurrentlyunlockedexp'] = "您应该使用域名锁定，除非您需要转让该域名";
...
$_LANG['twoiptimebasedexplain'] = "此两步验证使用了基于时间的算法获取它的两步验证。您的手机可用于生成验证码。如果您没有安装此类软件，我们推荐您使用 Google Authenticator，可适用于 iOS、Android 和 Windows 移动设备。";
$_LANG['twoipconfigureapp'] = "配置您的认证应用：";
$_LANG['twoipconfigurestep1'] = "首先选择添加新的基于时间的令牌";
$_LANG['twoipconfigurestep2'] = "然后使用您的应用扫描下面的二维码，或者手动输入此密钥：";
...
$_LANG['remoteAuthn']['mayHaveMultipleLinks'] = '将您的账户与以下的任意服务相关联，以简化您的登录体验。我们只需要使用此信息来验证您的账户，绝不会以您的身份发布任何信息。';
