...
$_LANG['loginintrotext'] = "访问此页您必须先登录！注意：用户中心的账户和密码与空间控制面板的用户名和密码不同。";
...
$_LANG['domainnsexp'] = "在DNS服务器中保留有该域名的 DNS 记录，比如 A 记录，MX 记录等修改 DNS 服务器一般在 24 小时内生效。";
...
$_LANG['domaincheckerinvalidtld2'] = "顶级域名无效。";
$_LANG['domaincheckerinvaliddomain'] = "请求的域名无效";
$_LANG['domaincheckernopricing'] = "顶价不适用于此顶级域名。";
...
$_LANG['twofaactivationintro'] = "双重验证增加了一个额外的保护层，登录。一旦启用和配置，您每次登录在您将被要求输入您的用户名和密码，以及一个安全代码的第二个因素.";
...
$_LANG['twofabackupcodeexpl'] = "在纸上写下来，并保证它的安全。<br/>这将是需要的，如果您曾经失去您的第二个因素的设备，或者是您无法使用.";
$_LANG['twofaconfirmpw'] = "输入您的密码";
$_LANG['twofa2ndfactorreq'] = "您的双重验证需要完成登录";
...
$_LANG['domaincheckertagline'] = "寻找您心仪的域名…";
